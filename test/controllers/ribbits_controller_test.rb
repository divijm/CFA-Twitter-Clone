...
class RibbitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ribbit" do
    assert_difference('Ribbit.count') do
      post ribbits_url, params: { ribbit: { croak: @ribbit.croak, frog_id: @ribbit.frog_id } }
    end
  ...
  test "should update ribbit" do
    patch ribbit_url(@ribbit), params: { ribbit: { croak: @ribbit.croak, frog_id: @ribbit.frog_id } }
